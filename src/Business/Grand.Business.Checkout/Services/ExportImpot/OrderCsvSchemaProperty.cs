...
public class OrderCsvSchemaProperty : ISchemaProperty<Order>
{
    private readonly ICountryService _countryService;

    public OrderCsvSchemaProperty(ICountryService countryService)
    {
    ...
    public virtual async Task<PropertyByName<Order>[]> GetProperties()
    {
        var properties = new[] {
            ...
            new PropertyByName<Order>("CreatedOnUtc", p => p.CreatedOnUtc.ToString("MM/dd/yyyy")),
