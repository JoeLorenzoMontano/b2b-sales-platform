...
public class AddressValidator : BaseGrandValidator<AddressModel>
{
    public AddressValidator(
        ...
        : base(validators)
    {
        // First Name, Last Name, Email, Company, Country, City, Address, Zip, Phone requirements disabled per user request
        ...
        RuleFor(x => x.Email)
            ...
            .When(x => x.EmailEnabled && !string.IsNullOrEmpty(x.Email));
